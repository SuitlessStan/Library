...
function BookLibrary() {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object().shape({
      bookTitle: Yup.string().max(50, "Must be 50 characters or less").required("Book title cannot be empty"),
      ...
      currentPage: Yup.number()
        .positive("this number must be more than 25")
      ...
      <Box bg={useColorModeValue("gray.100", "gray.900")} px={4}>
        ...
        <Flex h={16} alignItems={"center"} justifyContent={"space-between"}>
          ...
          <Box>
            <Container>
              <HStack>
                <Text fontWeight="bold" fontSize="xl" fontStyle="italic" fontFamily="Roboto">
            ...
            <form>
              <VStack spacing={10} paddingTop={3}>
                <Box width={"100%"}>
                  <FormControl
                    id="book-title"
                    isInvalid={validator(formik.touched.bookTitle, formik.errors.bookTitle)}
                  >
                    ...
                    {formik.errors.bookTitle && formik.touched.bookTitle && (
                      <FormErrorMessage>{formik.errors.bookTitle}</FormErrorMessage>
                    )}
                  </FormControl>
                </Box>
                <Box width={"100%"}>
                  <FormControl
                    id="book-author"
                    isInvalid={validator(formik.touched.bookAuthor, formik.errors.bookAuthor)}
                  >
                    ...
                    {formik.errors.bookAuthor && formik.touched.bookAuthor && (
                      <FormErrorMessage>{formik.errors.bookAuthor}</FormErrorMessage>
                    )}
                  </FormControl>
                </Box>
                <Box width={"100%"}>
                    ...
                    <VStack spacing={8}>
                      ...
                      <Center>
                        ...
                        {!formik.errors.currentPage && formik.touched.currentPage ? (
                          ...
                          <FormErrorMessage>{formik.errors.currentPage}</FormErrorMessage>
                        )}
                        {!formik.errors.bookPages && formik.touched.bookPages ? (
                          "test"
                        ) : (
                          <FormErrorMessage>{formik.errors.bookPages}</FormErrorMessage>
                        )}
                        {!formik.errors.readStatus && formik.touched.readStatus ? (
                          ""
                        ) : (
                          <FormErrorMessage>{formik.errors.readStatus}</FormErrorMessage>
                        )}
                      </Center>
                      {!formik.values.readStatus ? (
                        <VStack>
                          <HStack>
                            <FormControl
                              id="current-page"
                              isInvalid={validator(formik.touched.currentPage, formik.errors.currentPage)}
                            >
                            ...
                            <FormControl
                              id="book-pages"
                              isInvalid={validator(formik.touched.bookPages, formik.errors.bookPages)}
                            >
                          ...
                          {!(formik.errors.currentPage || formik.errors.bookPages) ? (
                ...
                <Box w="100%">
                  <FormControl
                    id="book-genre"
                    isInvalid={validator(formik.touched.bookGenre, formik.errors.bookGenre)}
                  >
                    ...
                    {formik.errors.bookGenre && formik.touched.bookGenre && (
                      <FormErrorMessage>{formik.errors.bookGenre}</FormErrorMessage>
                    )}
                  </FormControl>
                </Box>
                <Box width={"100%"}>
                  <FormControl
                    id="book-review"
                    isInvalid={validator(formik.touched.bookReview, formik.errors.bookReview)}
                  >
                    ...
                    <Textarea
                      ...
                      resize={"none"}
                    />
                    {!formik.errors.bookReview ? (
                      <FormHelperText>Add a review to the book you're reading</FormHelperText>
                    ) : (
                      <FormErrorMessage>{formik.errors.bookReview}</FormErrorMessage>
                    )}
                  </FormControl>
                </Box>
              </VStack>
